...
def initialize_and_train_model_experiment(dataloader,batch_size=32,epochs=15, randomize = True):
    ## TODO: Bring in randomization code from https://github.com/vaibhavs2854/ActiveLearningShapes/blob/709eeb5764c756d3192237849108614b90cab7bf/model.py
    #Initial training on mismatched image-label pairs (half matched w/ label 1, half mismatched w/ label 0)
    num_classes=2
